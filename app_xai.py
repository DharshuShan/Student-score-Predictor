...
def load_model_and_scaler():
    ...
    model_path = os.path.join(SCRIPT_DIR, 'final_exam_model1.pkl')
    scaler_path = os.path.join(SCRIPT_DIR, 'robust_scaler1.pkl')
    columns_path = os.path.join(SCRIPT_DIR, 'model_columns1.pkl')
